...
our $SCHEMA = [
    ...
    {begin_cat => ['Wine',  'cat-icon']},
        {item => ['wine "/home/korvinko/.wine/drive_c/Program Files (x86)/HeidiSQL/heidisql.exe"', 'HeidiSQL']},
    ...
    # Openbox category
#    {begin_cat => ['Power options', 'power']},
#	{item => ['openbox --exit', 'Logout', 'system-log-out']},
#    	{item => ['systemctl reboot', 'Reboot', 'start-here']},
